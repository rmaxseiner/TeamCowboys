...
globalYearly <- read.csv('data/GlobalYearly.csv')
str(globalYearly)
globalYearly

predictors <- globalYearly[c(2, 3, 4, 5, 6, 7, 8, 9, 10, 16, 17, 18, 19, 20, 21)]
y <- globalYearly[c("AverageTemperature")]
predictors
#Summary Statistics
summary(predictors)
...
skewness(predictors$log_Gas) #0.595
skewness(predictors$log_Coal) #1.912
skewness(predictors$log_Oil) #1.125
